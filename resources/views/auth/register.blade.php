<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- country_code -->
        <div>
            <x-input-label for="country_code" :value="__('Country_code')" />
            <x-text-input id="country_code" class="block mt-1 w-full" type="text" name="country_code" :value="old('country_code')" required autofocus autocomplete="country_code" />
